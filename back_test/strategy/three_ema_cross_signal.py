...
class ThreeEmaCrossSignal(bt.Indicator):
    ...
    def __init__(self):
        self.s_ma = bt.ind.EMA(period=self.p.short_period)
        self.m_ma = bt.ind.EMA(period=self.p.median_period)
        self.l_ma = bt.ind.EMA(period=self.p.long_period)
